...
class OrdenPago(models.Model):
	...
	egreso = models.ForeignKey(Egresos, on_delete=models.SET_NULL, blank=True, null=True)
	tipo_comprobante = models.CharField(max_length=5, choices=COMPROBANTE_CHOICES)

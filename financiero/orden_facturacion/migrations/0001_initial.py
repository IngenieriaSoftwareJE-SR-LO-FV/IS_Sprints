    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descuento_fact', models.FloatField(blank=True, default=0.0)),
                ('descuento_total', models.FloatField(blank=True, default=0.0)),
                ('valor_total', models.FloatField(blank=True, max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participante', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='personas_naturales.Persona_Natural')),
            ],
        ),
    ]

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ruc', models.CharField(max_length=13, primary_key=True, serialize=False, validators=[ventas.validaciones.validate_ruc])),
                ...
                ('forma_pago', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='personas_juridicas.FormaPago')),
